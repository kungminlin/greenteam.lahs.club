	...
	<div class="eight columns">
	  ...
	  <div class="profile row">
	    <div class="four columns">
	      <img class="headshot" src="/img/crossroads.jpg" />
	    </div>
	    <div class="eight columns">
	      <span class="name">Crossroads</span>
	      <span class="bio">
		Each year, TEDxGunnHighSchool aims to center its annual conference's content around a central theme. Previous themes have included <i>Be The Variable, More Than A Number, and Trailblazers</i>. This year, inspired by the convergence (and divergence) of many unexpected paths and ideas in our lives, we decided to choose our theme as <i>Crossroads</i>. <br /><br />
...
With our distinguished set of speakers and performers, we hope to provide a conference experience where the audience will explore how ideas along different paths intersect, such as artificial intelligence and art, tech startups and non-technical hustlers, happiness and high school, and social media and youth activism.
	...
	<div class="eight columns">
	  ...
	  <table>
	    ...
	    <tbody>
	      <tr>
		<td>Period 1</td>
		<td><b>Check-in &amp; Registration Begins</b></td>
	      </tr>
	      <tr>
		<td>Period 2</td>
		<td>Intro - <a href="#arman">Arman Moslehi</a></td>
	      </tr>
	      <tr>
		<td>Brunch</td>
		<td><a href="#brian">Brian Buntz</a></td>
	      </tr>
	      <tr>
		<td>Period 3</td>
		<td><a href="#trinity">Trinity Suh</a></td>
	      </tr>
	      <tr>
		<td>Tutorial</td>
		<td>Video 1: Linsey Pollack</td>
	      </tr>
	      <tr>
		<td>Period 4</td>
		<td><a href="#gunnhiphop">Gunn Hip Hop</a></td>
	      </tr>
	      <tr>
		<td>Lunch</td>
		<td><b>Intermission</b></td>
	      </tr>
	      <tr>
		<td>Period 5</td>
		<td><a href="#konstantin">Konstantin Guericke</a></td>
	      </tr>
	      <tr>
		<td>Period 6</td>
		<td>Video 2: Thordis Elva &amp; Tom Stranger</td>
	      </tr>
	      <tr>
		<td>Period 7</td>
		<td><a href="#youngjerry">Young Lee &amp; Jerry Guo</td>
	      </tr>
	    </tbody>
	  </table>
	</div>
	...
	<div class="eight columns">
		...
		<span class="bio">
		  ...
		  Throughout these trips, he has witnessed the transformative power of service, cultural immersion, and self-reflection. Brian developed the personal growth curriculum that students use on the trips to answer questions that young adults often face: Who do I want to be? How can I be deliberate in my decisions, not just letting life's current carry me where it will? What choices can I make that are in alignment with who I want to be? What are the values, interests, passions, and fire that get me out of bed in the morning — and how can I use them to make a real impact?<br /><br />

		  When he's not flying out for a service trip or on the ground in one of our international locations, Brian lives in the San Francisco Bay Area with his wife, Edna, and two young sons, all avid and enthusiastic world travelers. Brian has a Bachelor's degree in Business from the University of Iowa and an MA in Education from San Jose State University. He also holds a multi-subject teaching credential in the State of California.<br /><br />
		  <b>Brian will be speaking on the power of stepping out of your comfort zone.</b>
		</span>
	      </div>
	    </div>

	    <div class="profile row" id="kartikdoug">
	      <div class="two columns">
		<img class="headshot" src="/img/headshots/kartik.jpg" />
		<img class="headshot" src="/img/headshots/doug.jpg" />
	      </div>
	      <div class="ten columns">
		<span class="name">Kartik Chandra &amp; Doug Klink</span>
		<span class="bio">Kartik Chandra is an undergraduate at Stanford University studying computer science and English. He enjoys writing poetry, playing jazz, and cooking lasagna late at night.<br /><br />
		  ...
		  <br /><br />
		  <b>Kartik and Doug will be performing a set of original jazz compositions on the piano and violin.</b>
		</span>
	      </div>
	    </div>

	    <div class="profile row" id="youngjerry">
	      <div class="two columns">
		<img class="headshot" src="/img/headshots/youngandjerry.png" />
	      </div>
	      <div class="ten columns">
		<span class="name">Young Lee &amp; Jerry Guo</span>
		<span class="bio">
		  Young Lee and Jerry Guo are student philosophers from Palo Alto. Using their philosophical inquiries as a vehicle for exploration, they have discovered a lot about themselves and the world around them. They will share their insights the profound changes they have gone through their experiences with the reality and the virtual, combining ideas from the works of various philosophers, including Slavoj Zizek, Jacques Lacan, and Sajeeda Al-Hussein.<br /><br />

		  <b>They will be speaking on their experiences with reality and the virtual and the nature of philosophy in our everyday lives.</b>
		</span>
	      </div>
	    </div>

	    <div class="profile row" id="amjed">
	      <div class="two columns">
		<img class="headshot" src="/img/headshots/amjed.jpg" />
	      </div>
	      <div class="ten columns">
		<span class="name">Amjed Aboukhadijeh</span>
		<span class="bio">
		  Amjed is a rebel and a hustler who's passionate about getting disruptive technology into the hands of consumers. He attended college at UCLA, where he juggled academics (majoring in Economics), athletics (running on the Track & Field team), and entrepreneurship (starting his own financial brokerage – while still in school!). As a semi-professional runner, he could run a mile race in just 4 minutes and 7 seconds.<br /><br />

		  While in college, Amjed witnessed his older brother, who was somewhat of a child prodigy, build and sell his tech startup to the tech giant Yahoo. He decided at that moment to move to Silicon Valley and pursue his own success in the tech world. But, after a few faltering attempts to replicate his brother’s formula, he learned that his true gift was not for engineering but rather sales.<br /><br />
		...
		<span class="bio">
		  ...
		  <br /><br />
		  <b>Gunn Hip Hop will be performing an original, student-choreographed performance.</b>
		</span>
	      </div>
	    </div>

	    <div class="profile row" id="douglas">
	      <div class="two columns">
		<img class="headshot" src="/img/headshots/douglas.png" />
	      </div>
	      <div class="ten columns">
		<span class="name">Douglas Eck</span>
		<span class="bio">
		...
		<span class="bio">
		  ...
		  <br /><br />
		  <b>Advait will be speaking on the interactions of youth activism, politics, and social media.</b>
		</span>
	      </div>
	    </div>

	    <div class="profile row" id="jenny">
	      <div class="two columns">
		<img class="headshot" src="/img/headshots/jenny.jpg" />
	      </div>
	      <div class="ten columns">
		<span class="name">Jenny Gao</span>
		<span class="bio">
		  ...
		  <br /><br />
		  <b>Jenny will be speaking about overcoming outside expectations and self-acceptance.</b>
		</span>
	      </div>
	    </div>

	    <div class="profile row" id="trinity">
	      <div class="two columns">
		<img class="headshot" src="/img/headshots/trinity.jpg" />
	      </div>
	      <div class="ten columns">
		<span class="name">Trinity Suh</span>
		<span class="bio">
		  ...
		  <b>Trinity will be speaking about her journey as an author of three novels and her beliefs that writing is the solution to all problems.</b>
		</span>
	      </div>
	    </div>

	    <div class="profile row" id="arman">
	      <div class="two columns">
		<img class="headshot" src="/img/headshots/arman.jpg" />
	      </div>
	      <div class="ten columns">
		<span class="name">Arman Moslehi</span>
		<span class="bio">
		  Arman Moslehi is a junior at Gunn High School.<br />

		  <b>He will be the MC for our 2018 TEDx conference.</b>
		</span>
	      </div>
	    </div>
